...
celery_app.conf.beat_schedule = {
    "charge-due-subscriptions": {
        "task": "app.tasks.payment_tasks.process_due_payments",
        "schedule": crontab(hour=1, minute=0),
    },
    "enforce-grace-periods": {
        "task": "app.tasks.business_tasks.enforce_grace_periods",
        "schedule": crontab(hour=0, minute=0),
    },
    "generate-manufacturer-forecast": {
        "task": "app.tasks.business_tasks.generate_manufacturer_forecast",
